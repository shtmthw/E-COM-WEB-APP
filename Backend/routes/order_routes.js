import { order_confirmation,order_placement,send_orders ,getTotalPages,fetch_singleUser_order ,Order_paymentVerificaiton,filter_confirmed_orders ,handle_order_status } from "../controllers/order_controls.js";
import { WTC_DECR } from "../middlewares/WBThandler.js";
import express from 'express'
const order_routes = express.Router()

//use in A/P to get evey order
order_routes.post('/fetch_all_orders' , send_orders)
...
order_routes.get('/filter_confirmed_orders', filter_confirmed_orders)
...
//use in A/P to get total aomount of pages 
order_routes.get('/getTotalPages' , getTotalPages)
