...
import { add_itemm , fetch_items ,fetchSingleItems, getItemsPageNumbers,getItemBySearch,del_item , update_item_ordered_amnt , get_mostBoughtProducts} from '../controllers/item_controls.js';
...
item_route.get('/getItemsPageNumbers' , getItemsPageNumbers)

item_route.post('/add_item' , upload.single('image') , add_itemm )
item_route.post('/getall_item' , fetch_items)
...
item_route.post('/getItemBySearch' , getItemBySearch)
item_route.post('/fetchSingleItems' , fetchSingleItems)
