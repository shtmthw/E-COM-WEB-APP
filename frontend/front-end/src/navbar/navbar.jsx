...
function Navbar() {
    ...
    const { token, setToken, user_img, setUser_img ,setShowSearchPopup,showSearchPopup } = useContext(StoreContext);
    ...
    return (
        <>
                    ...
                    <div className="user">
                        ...
                        {token ? (
                            <>
                                <img 
                                    onClick={() => {
                                        setShowSearchPopup(!showSearchPopup);  // Toggle search popup visibility
                                    }} 
                                    src={search} 
                                    alt="" 
                                ...
                                <img 
                                    ...
                                    src={`http://localhost:5000/user_images/${user_img}`} 
                                    width={120} 
                                    alt="" 
                                />
            ...
            {/* Conditionally render the SearchPopup component */}
